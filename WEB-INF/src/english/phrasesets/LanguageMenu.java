...
public class LanguageMenu extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: English
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "English", "English.wav", "For English"); 

		// phrase: Tamil
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "Tamil", "Tamil.wav", "For Tamil"); 

		// phrase: Hindi
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "Hindi", "Hindi.wav", "For Hindi"); 

		// phrase: AutoLanguage
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "AutoLanguage", "AutoLanguage.wav", "English Language is Automatically Selected"); 

		// phrase: NoInputLanguageMenu
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "NoInputLanguageMenu", "NoInputLanguageMenu.wav", "You have not selected yet."); 
	 ...
	 * Last generated by Orchestration Designer at: 2022-DEC-07  05:54:00 PM

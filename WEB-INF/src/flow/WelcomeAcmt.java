...
public class WelcomeAcmt extends com.avaya.sce.runtime.Form {
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2023-JAN-07  06:59:54 PM
	 */
	...
	public void requestBegin(SCESession mySession) {
		...
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "UCID: "+mySession.getVariableField(IProjectVariables.SESSION_FIELD_UCID).getIntValue(), mySession);
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "DNIS: "+mySession.getVariableField(IProjectVariables.SESSION_FIELD_DNIS).getIntValue(), mySession);
//		UCID	->	public static final String SESSION_FIELD_UCID = "ucid";
//		Flow name
//		CLID
//		DNIS	->	public static final String SESSION_FIELD_DNIS = "dnis";
//		StartDate yyyy-mm-dd HH:mm:ss.sss
//		EndDate
//		Duration
//		ExitLocation
//		EndReason -Disconnect/Hangup/Transfer
//		App IP
	}
}

...
public class GetDatePC extends com.avaya.sce.runtime.Form {
	 ...
	 * by Orchestration Designer at: 2022-DEC-17 05:44:30 PM
	 * 
	 ...
	 * Orchestration Designer at: 2022-DEC-17 05:44:30 PM
	 * 
	 ...
	 * mySession) Last generated by Orchestration Designer at: 2022-DEC-17 05:44:30
	 * PM
	 */
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT,
				...
				new com.avaya.sce.runtime.Goto("AddBooking-GetDatePCAtmt", 0, true, ""));
		events.add(event);
		...
		nbest = 1;
		field = new com.avaya.sce.runtime.Field("GetDatePC", false, true, grammarInfo, promptNames, events, properties,
				nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);

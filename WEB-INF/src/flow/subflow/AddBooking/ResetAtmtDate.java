 ...
 * 11:19:29 AM
 */
public class ResetAtmtDate extends com.avaya.sce.runtime.Subflow {
	...
	protected java.util.Map<String, String> getExitPoints() {
		...
		exitPoints.put("AttemptReset-GoNext", "AddBooking-GetTimePC");
		return exitPoints;
	}

	@Override
	public void requestBegin(SCESession mySession) {
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "ResetAtmtDate Node", mySession);
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_DEBUG, "ResetAtmtDate Attempts : "

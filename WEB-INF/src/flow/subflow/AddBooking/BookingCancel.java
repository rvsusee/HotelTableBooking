 ...
 * Last generated by Orchestration Designer at: 2022-DEC-12  03:34:56 PM
 */
public class BookingCancel extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("BookingCancel", ""));
	...
	public void requestBegin(SCESession mySession) {
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "BookingCancelAcmt Node", mySession);
		mySession.getVariableField(IProjectVariables.CALL_HISTORY_INFO,IProjectVariables.CALL_HISTORY_INFO_FIELD_EXIT_LOCATION).setValue("BookingCancelAcmt Node");

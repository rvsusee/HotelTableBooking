	...
	public void requestBegin(SCESession mySession) {
		...
		if (database.status()) {
			try {
				...
				ResultSet resultSet = stmt.executeQuery("SELECT TOP 1 * FROM SUSEENDHIRAN_HOTEL_TABLE_BOOKING ORDER BY bookingID DESC;");
				...
				TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
						"Booking No Generated Successfully. No:" + (resultSet.getInt(0) + 1), mySession);
				stmt.close();

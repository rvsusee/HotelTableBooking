 ...
 * 11:10:02 AM
 */
public class ResetExitAtmt extends com.avaya.sce.runtime.Subflow {
	...
	protected java.util.Map<String, String> getExitPoints() {
		...
		exitPoints.put("ResetExit-Exit", "AddBooking-MoreAtmtEnd");
		return exitPoints;
	}

	@Override
	public void requestBegin(SCESession mySession) {
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "ResetExitAtmt", mySession);
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "No More Attempts: Attempts: "

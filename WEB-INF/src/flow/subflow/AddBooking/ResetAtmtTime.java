 ...
 * 11:28:09 AM
 */
public class ResetAtmtTime extends com.avaya.sce.runtime.Subflow {
	...
	protected java.util.Map<String, String> getExitPoints() {
		...
		exitPoints.put("AttemptReset-GoNext", "AddBooking-GetDurationPC");
		return exitPoints;
	}

	@Override
	public void requestBegin(SCESession mySession) {
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "ResetAtmtTime Node", mySession);
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_DEBUG, "ResetAtmtTime Attempts : "

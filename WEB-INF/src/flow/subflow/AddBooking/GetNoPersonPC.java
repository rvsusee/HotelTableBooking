 ...
 * executing Last generated by Orchestration Designer at: 2022-DEC-07 02:45:06
 * PM
 */
public class GetNoPersonPC extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2023-JAN-18  05:25:25 PM
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("AddBooking-MoreAtmtExitAcmt", 3, true, ""));
		events.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("AddBooking-MoreAtmtExitAcmt", 3, true, ""));
		events.add(event);
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2023-JAN-18  05:25:25 PM
	 */
	...
	public void requestBegin(SCESession mySession) {
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "GetNoPersonPC node ", mySession);
		mySession.getVariableField(IProjectVariables.CALL_HISTORY_INFO,IProjectVariables.CALL_HISTORY_INFO_FIELD_EXIT_LOCATION).setValue("GetNoPersonPC Node");

...
public class GetNoPersonPC extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT,
				...
				new com.avaya.sce.runtime.Goto("AddBooking-PersonAtmt", 0, true, ""));
		events.add(event);
		...
		nbest = 1;
		field = new com.avaya.sce.runtime.Field("GetNoPersonPC", false, true, grammarInfo, promptNames, events,
				properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);

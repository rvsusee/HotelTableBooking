 ...
 * Last generated by Orchestration Designer at: 2022-DEC-07  05:44:51 PM
 */
public class GetDurationPC extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("GetDurationPC", ""));

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("GetDurationPCGrammar", "1.0"));


		// build events for the field: "GetDurationPC"
		events = new java.util.ArrayList(2);

		// build the list of prompt names
		eventPromptNames = new java.util.ArrayList(1);
		
		eventPromptNames.add(new com.avaya.sce.runtime.PromptRefInfo("GetDurationPCNoInput", ""));
		...
		eventPromptNames.add(new com.avaya.sce.runtime.PromptRefInfo("GetDurationPCNoMatch", ""));
		...
		nbest = 1;
		field = new com.avaya.sce.runtime.Field("GetDurationPC", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);

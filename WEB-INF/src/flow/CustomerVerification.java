...
public class CustomerVerification extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "validation:isExistCustomer", com.avaya.sce.runtime.Expression.STRING_EQUAL, "true", false).setDebugId(740)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("PinPC", "ExistingCustomer").setDebugId(743));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("PinPC", "NewCustomer").setDebugId(736));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		try {
			...
			if (response != null) {
				if (response.getInt("httpStatus") == 202) {
					...
					TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "Response : " + responseBody, mySession);

...
public class CustomerAuth extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "validation:isLogin", com.avaya.sce.runtime.Expression.STRING_EQUAL, "true", false).setDebugId(831)).evaluate(mySession)) {
			...
			actions.add(new com.avaya.sce.runtime.Next("LanguageMenu", "Success").setDebugId(832));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

...
public class Start extends com.avaya.sce.runtime.Entry {
	 ...
	 * Last generated by Orchestration Designer at: 2023-FEB-06  12:40:08 PM
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.BOOKING_DETAILS, variableFields, new String[] {"10304050", "", "8838930954", "", "", "no"}, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.CALL_HISTORY_INFO_FIELD_DURATION,
			IProjectVariables.CALL_HISTORY_INFO_FIELD_END_DATE,
			IProjectVariables.CALL_HISTORY_INFO_FIELD_END_REASON,
			IProjectVariables.CALL_HISTORY_INFO_FIELD_EXIT_LOCATION,
			IProjectVariables.CALL_HISTORY_INFO_FIELD_IP,
			IProjectVariables.CALL_HISTORY_INFO_FIELD_START_DATE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CALL_HISTORY_INFO, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.VALIDATION_FIELD_ATTEMPT_COUNT,
			IProjectVariables.VALIDATION_FIELD_IS_API_CONNECT,
			IProjectVariables.VALIDATION_FIELD_IS_EXIST_CUSTOMER,
			IProjectVariables.VALIDATION_FIELD_IS_HAVE_LAST_BOOKING,
			IProjectVariables.VALIDATION_FIELD_IS_LOGIN,
			IProjectVariables.VALIDATION_FIELD_IS_NO_OF_PERSON,
			IProjectVariables.VALIDATION_FIELD_IS_PAST_DATE,
			IProjectVariables.VALIDATION_FIELD_IS_VALID_BOOKING_NO,
			IProjectVariables.VALIDATION_FIELD_IS_VALID_DATE,
			IProjectVariables.VALIDATION_FIELD_IS_VALID_DATE_TIME,
			IProjectVariables.VALIDATION_FIELD_IS_VALID_TIME };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.VALIDATION, variableFields, new String[] {"0", "false", "false", "false", "", "", "false", "", "false", "false", "false"}, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.AUDIO_PATH_FIELD_EXIST_CUSTOMER_ENTER_PIN,
			IProjectVariables.AUDIO_PATH_FIELD_NEW_CUSTOMER_ENTER_PIN,
			IProjectVariables.AUDIO_PATH_FIELD_TESTING };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.AUDIO_PATH, variableFields, new String[] {"http://172.16.11.191:8050/Audio/HotelTableBooking/English/ExistCustomerEnterPin.wav", "http://172.16.11.191:8050/Audio/HotelTableBooking/English/NewCustomerEnterPin.wav", ""}, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.CUSTOMER_DETAILS_FIELD_EMAIL_ID,
			IProjectVariables.CUSTOMER_DETAILS_FIELD_ID,
			IProjectVariables.CUSTOMER_DETAILS_FIELD_MOBILE_NUMBER,
			IProjectVariables.CUSTOMER_DETAILS_FIELD_NAME,
			IProjectVariables.CUSTOMER_DETAILS_FIELD_PIN };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CUSTOMER_DETAILS, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.PIN_PC_FIELD_CONFIDENCE,
			IProjectVariables.PIN_PC_FIELD_INPUTMODE,
			IProjectVariables.PIN_PC_FIELD_INTERPRETATION,
			IProjectVariables.PIN_PC_FIELD_NOINPUTCOUNT,
			IProjectVariables.PIN_PC_FIELD_NOMATCHCOUNT,
			IProjectVariables.PIN_PC_FIELD_UTTERANCE,
			IProjectVariables.PIN_PC_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.PIN_PC, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.MOBILE_NO, "", null, session, false, false );
		session.putVariable(variable);

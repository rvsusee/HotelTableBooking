 ...
 * executing Last generated by Orchestration Designer at: 2022-DEC-07 01:01:19
 * PM
 */
public class EngMainMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT,
				...
				new com.avaya.sce.runtime.Goto("Disconnect", 3, true, ""));
		list.add(event);
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("LastBookingDetails", "2", true, "exact", "LastBookingDetails",
				grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("CancelBooking", "4", true, "exact", "GetCancelNoPC", grammarInfo,
				true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("ChangeLanguage", "8", true, "exact", "LanguageMenu", grammarInfo,
				true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("TransferToAgent", "9", true, "exact", "WaitingToTransferCall",
				grammarInfo, true);
		list.add(choice);

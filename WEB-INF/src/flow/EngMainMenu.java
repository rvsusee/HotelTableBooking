...
public class EngMainMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("NewBooking", "1", true, "exact", "GetBookingFromUser", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("LastBookingDetails", "2", true, "exact", "GetLastBookingDetails", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("EditBooking", "3", true, "exact", "GetBookingNoPC", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("CancelBooking", "4", true, "exact", "CancelBooking", grammarInfo, true);
		list.add(choice);

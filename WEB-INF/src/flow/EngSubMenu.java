...
public class EngSubMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("EditBooking", "2", true, "exact", "GetBookingFromUser", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("CancelBooking", "3", true, "exact", "CancelBooking", grammarInfo, true);
		list.add(choice);

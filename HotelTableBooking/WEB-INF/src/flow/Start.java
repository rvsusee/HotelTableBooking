...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.USER_DETAILS_FIELD_EMAIL_ID,
			IProjectVariables.USER_DETAILS_FIELD_MOBILE_NO,
			IProjectVariables.USER_DETAILS_FIELD_USER_ID,
			IProjectVariables.USER_DETAILS_FIELD_USER_NAME };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.USER_DETAILS, variableFields, new String[] {"", "8838930954", "", ""}, null, session, false, false );
		session.putVariable(variable);

...
public class GetConfirmOrNot extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 2022-DEC-12  03:13:09 PM
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Confirm", "1", true, "exact", "AddBooking-Return", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Cancel", "3", true, "exact", "AddBooking-Return", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("MainMenu", "4", true, "exact", "AddBooking-Return", grammarInfo, true);
		list.add(choice);
